...
<body class="home-page home-01 ">
			...
			<div class="row">				
				...
				<div class="nav-section header-sticky">
					<div class="header-nav-section">
						<div class="container">
							<ul class="nav menu-nav clone-main-menu col-md-12" id="mercado_haead_menu" data-menuname="Sale Info" >
								<li class="menu-item col-md-2"><a href="#" class="link-term">Weekly Featured</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item col-md-2"><a href="#" class="link-term">Hot Sale</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item col-md-3"><a href="#" class="link-term">Top new items</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item col-md-2"><a href="#" class="link-term">Top Selling</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item col-md-3"><a href="#" class="link-term">Top rated items</a><span class="nav-label hot-label">hot</span></li>
							</ul>
						</div>
					</div>
	...
	<script src="{{ asset('assets/js/jquery-ui-1.12.4.minb8ff.js?ver=1.12.4') }}"></script> {{-- wasnt there --}}
	<script src="{{ asset('assets/js/bootstrap.min.js') }}"></script>
	<script src="{{ asset('assets/js/jquery.flexslider.js') }}"></script>
	{{--<script src="{{ asset('assets/js/chosen.jquery.min.js') }}"></script> --}}	{{--commented out by instr--}}
	<script src="{{ asset('assets/js/owl.carousel.min.js') }}"></script>
	<script src="{{ asset('assets/js/jquery.countdown.min.js') }}"></script> {{-- wasnt there --}}
